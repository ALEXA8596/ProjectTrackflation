...
const folderPath = path.join(__dirname, "olympic_csv");
...
async function calculateLinearRegressionAnalysis() {
  ...
  for (const file of files) {
    ...
    const isFieldEvent = ["shot-put", "discus-throw", "long-jump", "high-jump", "triple-jump"].includes(
  ...
  // Output results
  console.log("Olympic Events Linear Regression Analysis");
